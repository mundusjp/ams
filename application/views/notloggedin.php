...
<body class="horizontal-nav skin-megna card-no-border">
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url(assets/vertical/images/background/bg1.jpg);">
                ...
                <div class="card-body">
                  <div class="container">
                    ...
                    <form class="form-horizontal form-material" id="loginform" action="<?php echo base_url('auth/login')?>" method="post">
                        ...
                        <h3 class="box-title m-b-20">Sign In, Again.</h3>
                        ...
                        <div class="row justify-content-md-center">
                          <div class="col-12 col-md-auto">
                            <h6 class="text-danger"> Username atau Password Salah! Silahkan Isi Kembali. </h6>
                          </div>
                        </div>
                        <br>
