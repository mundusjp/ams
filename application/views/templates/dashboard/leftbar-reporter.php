<ul id="sidebarnav">
    <li class="user-pro"> <a aria-expanded="false"><img src="<?php echo base_url("assets/vertical/images/users/".$user['photo'])?>" alt="user-img" class="img-circle"><span class="hide-menu">Reporter</span></a></li>
    <br>
      ...
      <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-note"></i><span class="hide-menu">Transactions</span></a>
