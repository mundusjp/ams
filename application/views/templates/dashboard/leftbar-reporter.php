<ul id="sidebarnav">
    ...
    <li class="user-pro"> <a aria-expanded="false"><img src="<?php echo base_url("assets/vertical/images/users/".$user_img)?>" alt="user-img" class="img-circle"><span class="hide-menu">Reporter</span></a></li>
    <br>
