<ul id="sidebarnav">
              <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="<?php echo base_url('assets/vertical/images/users/manager.png')?>" alt="user-img" class="img-circle"><span class="hide-menu">Master</span></a>
              <li class="nav-small-cap"></li>
                ...
                <li> <a class="waves-effect waves-dark" href="<?php echo base_url('kebutuhan/index')?>" aria-expanded="false"><i class="icon-bag"></i><span class="hide-menu">Shopping List</span></a></li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-note"></i><span class="hide-menu">Manage Stock</span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="<?php echo base_url('stock/overview')?>">Overview</a></li>
