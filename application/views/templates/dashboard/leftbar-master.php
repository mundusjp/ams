<ul id="sidebarnav">-
              <li class="user-pro"> <a aria-expanded="false"><img src="<?php echo base_url("assets/vertical/images/users/".$user['photo'])?>" alt="user-img" class="img-circle"><span class="hide-menu">Master</span></a></li>
              <br>
