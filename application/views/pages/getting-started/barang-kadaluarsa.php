    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Getting Started - Barang Kadaluwarsa</h4>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="card-body wizard-content">
                    ...
                    <h6 class="card-subtitle">Ikuti Langkah untuk Memasukkan List Barang Kadaluwarsa</a></h6>
                    <form action="#" class="tab-wizard wizard-circle">
                        <!-- Step 1 -->
                        <h6>Barang Kadaluwarsa</h6>
                        <section>
                          <div class="row">
                            <div class="col-lg-12 content-mid">
                              <div class="card">
                                <img class="card-img" src="<?php echo base_url('assets/vertical/images/background/kadaluarsa.jpg')?>">
                                <div class="card-img-overlay card-inverse">
                                  ...
                                  text-align: center;"><h3 class="font-weight-bold">Masa Guna Barang Telah Habis. Lalu apa?</h3><br><h4 class="text-white">Ikuti dan isi form sesuai langkah yang disediakan. Ready? Click "Next" Di bawah!</h4></span>
                                </div>
                              </div>
                            </div>
                          </div>
