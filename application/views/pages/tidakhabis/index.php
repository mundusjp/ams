                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body"><div class="row"><div class="col-lg-12">
                                              <?php echo form_open('inventory/edit_bthp'); ?>
                                              ...
                                              <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                  <div class="form-group m-b-40">
                                                      ...
                                                      <input class="form-control" type="text" name="merk" value="<?php echo $this->input->post('merk'); ?>" />
                                                ...
                                                <div class="col-md-2">
                                                  <div class="form-group m-b-40">
                                                      ...
                                                      <input  class="form-control" type="text" name="kondisi" value="<?php echo $this->input->post('kondisi'); ?>" />
                                                ...
                                                <div class="col-md-2">
                                                  <div class="form-group m-b-40">
                                                      ...
                                                      <input class="form-control" type="text" name="durability" value="<?php echo $this->input->post('durability'); ?>" />
                                              ...
                                              <div class="row">
                                                <div class="col-md-3">
                                                  <div class="form-group m-b-40">
                                                    <label><h6 class="font-weight-bold">Nota Transaksi</h6></label>
                                                    <input class="form-control" type="text" name="transaksi" value="<?php echo $this->input->post('id_transaksi'); ?>">
                                                    <span class="text-danger"><?php echo form_error('transaksi');?></span>
                                                  </div>
                                                </div>
                                                <div class="col-md-3">
                                                  <div class="form-group m-b-40">
                                                     ...
                                                     <select name="kategori" class="form-control" >
                                                       ...
                                                       <?php $selected = ("beli" == $this->input->post('kategori')) ? ' selected="selected"' : "";?>
                                                       <option value="sewa">Penyewaan</option>
                                                       <?php $selected = ("sewa" == $this->input->post('kategori')) ? ' selected="selected"' : "";?>
                                                     </select>
                                                ...
                                                <div class="col-md-3">
                                                  <div class="form-group m-b-40">
                                                      ...
                                                      <input class="form-control" type="text" name="harga" value="<?php echo $this->input->post('harga'); ?>" />
                                                        ...
                                                        <div class="modal-body"><div class="row"><div class="col-lg-12">
                                                          ...
                                                          <div class="row">
                                                            <div class="col-md-3">
                                                              <div class="form-group m-b-40">
                                                                <label><h6 class="font-weight-bold">Nota Transaksi</h6></label>
                                                                <input class="form-control" type="text" name="transaksi" value="<?php echo ($this->input->post('id_transaksi') ? $this->input->post('id_transaksi') : $i->id_transaksi); ?>">
                                                                <span class="text-danger"><?php echo form_error('transaksi');?></span>
                                                              </div>
                                                            </div>
                                                            <div class="col-md-3">
