<?php echo form_open('eventlog/edit/'.$eventlog['id_event'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_user" class="form-control">
				...
				{
					$selected = ($user['id_user'] == $eventlog['id_user']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="event" value="<?php echo ($this->input->post('event') ? $this->input->post('event') : $eventlog['event']); ?>" class="form-control" id="event" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="ref_id" value="<?php echo ($this->input->post('ref_id') ? $this->input->post('ref_id') : $eventlog['ref_id']); ?>" class="form-control" id="ref_id" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="eventDesc" value="<?php echo ($this->input->post('eventDesc') ? $this->input->post('eventDesc') : $eventlog['eventDesc']); ?>" class="form-control" id="eventDesc" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="eventTable" value="<?php echo ($this->input->post('eventTable') ? $this->input->post('eventTable') : $eventlog['eventTable']); ?>" class="form-control" id="eventTable" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="eventTime" value="<?php echo ($this->input->post('eventTime') ? $this->input->post('eventTime') : $eventlog['eventTime']); ?>" class="form-control" id="eventTime" />
